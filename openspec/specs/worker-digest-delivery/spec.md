# worker-digest-delivery Specification

## Purpose
Define the worker-side orchestration, digest rendering, scheduled execution, and delivery workflow needed to turn ranked hotspot events into an outbound daily digest.
## Requirements
